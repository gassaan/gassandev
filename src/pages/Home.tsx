...
export function Home() {
  ...
  return (
    <div className="hero-wash hero-screen flex flex-col items-center justify-center gap-9 px-6 py-16 text-center">
      ...
      {/* rtl:leading-[1.5] loosens the Dhivehi headline specifically:
          Democrats Akuru's swashes and dot marks crowd each other at the
          1.15 tuned for the Latin serif, so the English headline keeps its
          tight leading and only the Thaana one gets the looser value. */}
