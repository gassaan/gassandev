...
values
  ...
  ('7771111','dhiraagu','premium',array['Triple 7','Repeating pair']::text[],8000,null,'available',false,'2026-07-20T09:00:00Z'),
  ...
  ('7900000','dhiraagu','premium',array['Round number','Easy to remember']::text[],6000,null,'available',false,'2026-07-29T09:00:00Z'),
  ('7878787','dhiraagu','premium',array['Alternating','Easy to remember']::text[],9500,7900,'available',true,'2026-08-01T09:00:00Z'),
  ...
  ('9611111','ooredoo','premium',array['Repeating pair','Easy to remember']::text[],7500,null,'available',true,'2026-07-20T10:00:00Z'),
  ...
  ('9700000','ooredoo','premium',array['Round number','Easy to remember']::text[],5800,null,'available',false,'2026-07-29T10:00:00Z'),
  ('9797979','ooredoo','premium',array['Alternating','Easy to remember']::text[],9000,null,'available',false,'2026-08-02T10:00:00Z'),
